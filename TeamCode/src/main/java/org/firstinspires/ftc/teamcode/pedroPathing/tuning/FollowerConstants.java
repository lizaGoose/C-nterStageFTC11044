...
public class FollowerConstants {
    ...
    private static double xMovement = 62.02802283147018;
    private static double yMovement = 35.186476799752256;
    ...
    public static double mass = 18.65942;
    ...
    // this is for curves
    public static double forwardZeroPowerAcceleration = -32.831728827510894;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    // this is for curves
    public static double lateralZeroPowerAcceleration = -175.24273847786876;
